...
export class MobileController {
  ...
  async register(@Body() body: { firstName: string; lastName: string; email: string; phone?: string; password: string }) {
  ...
  async socialLogin(@Body() body: { provider: string; email?: string; name?: string; id?: string }) {
  ...
  @UseInterceptors(FileInterceptor('file', {
    ...
    fileFilter: (_req, file, cb) => {
      if (!file.mimetype.match(/^image\/(png|jpe?g|webp)$/)) {
        cb(new BadRequestException('Format non accepté (png, jpg, webp)'), false)
      } else { cb(null, true) }
    },
    limits: { fileSize: 5 * 1024 * 1024 },
  }))
  @ApiConsumes('multipart/form-data')
  @ApiOperation({ summary: 'Uploader la photo de profil (enregistre et retourne l\'URL)' })
  ...
  async productById(@Param('id') id: string) { return this.service.getProductById(id) }

  @Public()
  @Get('products/:id/reviews')
  @ApiOperation({ summary: 'Avis clients actifs d\'un produit' })
  async productReviews(@Param('id') id: string) { return this.service.getProductReviews(id) }
  ...
  async categories() { return this.service.getCategories() }

  @Public()
  @Get('categories/:id/products')
  @ApiOperation({ summary: 'Produits par catégorie (format mobile)' })
  async productsByCategory(@Param('id') id: string) { return this.service.getProductsByCategory(id) }

  @Public()
  @Get('categories/:id/children')
  @ApiOperation({ summary: 'Sous-catégories d\'une catégorie (format mobile)' })
  async categoryChildren(@Param('id') id: string) { return this.service.getCategoryChildren(id) }
  ...
  async banners(@Query('screen') screen?: string) { return this.service.getBanners(screen) }
  ...
  @Get('feed')
  @ApiOperation({ summary: 'Posts du feed (avec liked par le client connecté si jeton fourni)' })
  async feed(@CurrentUser() user: any) { return this.service.getFeedPosts(user?.id) }
  ...
  async suggestedPeople() { return this.service.getSuggestedPeople() }

  @Public()
  @Get('shortcuts')
  @ApiOperation({ summary: 'Raccourcis accueil' })
  async shortcuts() { return this.service.getHomeShortcuts() }
  ...
  @ApiOperation({ summary: 'Codes ISO des pays couverts par les zones de livraison actives (admin)' })
  async shippingCountries() { return this.service.getShippingCountries() }

  @Public()
  @Get('shipping-quote')
  @ApiOperation({ summary: 'Devis de livraison pour le checkout (zone + repli global)' })
  async shippingQuote(@Query('country') country?: string, @Query('subtotal') subtotal?: string) {
    return this.service.getShippingQuote({ country, subtotal: subtotal ? Number(subtotal) : 0 })
  }

  @Public()
  @Get('cart/recommendations')
  @ApiOperation({ summary: 'Produits « Vous aimerez aussi » du panier (source choisie par l\'admin)' })
  async cartRecommendations() { return this.service.getCartRecommendations() }

  @Public()
  @Get('feed-sections/:id/products')
  @ApiOperation({ summary: 'Tous les produits d\'une section (écran « Voir tout »)' })
  async feedSectionProducts(@Param('id') id: string) { return this.service.getFeedSectionProducts(id) }

  @Public()
  @Get('settings')
  @ApiOperation({ summary: 'Paramètres application (branding)' })
  async settings() { return this.service.getAppSettings() }

  @Public()
  @Get('logos')
  @ApiOperation({ summary: 'Logos application' })
  async logos() { return this.service.getLogos() }

  @Public()
  @Get('social-links')
  @ApiOperation({ summary: 'Liens réseaux sociaux' })
  async socialLinks() { return this.service.getSocialLinks() }

  @Public()
  @Get('seo')
  @ApiOperation({ summary: 'Méta-données SEO' })
  async seo() { return this.service.getSEOMetadata() }

  @Public()
  @Get('static-pages')
  @ApiOperation({ summary: 'Liste des pages d\'information publiées (gérées par l\'admin)' })
  async staticPagesList() { return this.service.listStaticPages() }

  @Public()
  @Get('static-pages/:slug')
  @ApiOperation({ summary: 'Page statique par slug (CGU, mentions légales, etc.)' })
  async staticPageBySlug(@Param('slug') slug: string) { return this.service.getStaticPageBySlug(slug) }
  ...
  @UseInterceptors(FileInterceptor('image', {
    ...
    fileFilter: (_req, file, cb) => {
      ...
      cb(ok ? null : new Error('Seules les images JPEG/PNG/WebP sont acceptées'), ok)
    },
  }))
  ...
  async paymentMethods() { return this.service.getPaymentMethods() }

  @Public()
  @Get('payment/card-brands')
  @ApiOperation({ summary: 'Marques de cartes acceptées' })
  async cardBrands() { return this.service.getCardBrands() }
  ...
  async stores(@Query('limit') limit?: string) {
    return this.service.getStores({ limit: limit ? parseInt(limit, 10) : undefined })
  }
  ...
  async activeCoupons() { return this.service.getActiveCoupons() }
  ...
  async featureFlags() { return this.service.getFeatureFlags() }
  ...
  async updateMyAddress(@CurrentUser() user: any, @Param('id') id: string, @Body() body: any) {
    if (!user?.id) throw new UnauthorizedException('Connexion requise')
  ...
  async getWallet(@CurrentUser() user: any) {
    if (!user?.id) return { balance: 0, lifetime: 0, tier: 'bronze', totalSavings: 0 }
  ...
  async registerPushToken(@CurrentUser() user: any, @Body() body: { token: string; platform?: string }) {
    if (!user?.id) throw new UnauthorizedException('Connexion requise')
  ...
  async submitSuggestion(@CurrentUser() user: any, @Body() body: { content: string }) {
