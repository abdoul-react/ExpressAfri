...
describe('ChatService', () => {
  ...
  describe('getConversation', () => {
    ...
    it('throws NotFoundException if conversation not found', async () => {
      ...
      await expect(service.getConversation('1', 'c1')).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('closeConversation', () => {
    ...
    it('throws NotFoundException if conversation not found', async () => {
      ...
      await expect(service.closeConversation('1', 'c1')).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('markAsRead', () => {
    ...
    it('throws NotFoundException if conversation not found', async () => {
      ...
      await expect(service.markAsRead('1', 'c1')).rejects.toThrow(
        NotFoundException,
      );
    });
  });
