...
export class AdminMessagesController {
  ...
  @ApiOperation({
    summary:
      'Répondre depuis admin (texte et/ou pièce jointe, citation optionnelle)',
  })
  ...
  @Get('chat/:id/media')
  @ApiOperation({
    summary: "Médias, documents et liens d'une conversation chat",
  })
  ...
  @ApiOperation({
    summary: "Changer le statut d'une conversation chat (open/closed)",
  })
