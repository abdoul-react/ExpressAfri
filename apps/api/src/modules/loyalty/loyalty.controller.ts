...
export class LoyaltyController {
  ...
  async listRules(@Query() query: any) { return this.service.listRules(query) }
  ...
  async listRewards(@Query() query: any) { return this.service.listRewards(query) }

  @Post('rewards')
  @ApiOperation({ summary: 'Créer une récompense' })
  async createReward(@Body() body: any) { return this.service.createReward(body) }

  @Put('rewards/:id')
  @ApiOperation({ summary: 'Modifier une récompense' })
  async updateReward(@Param('id') id: string, @Body() body: any) { return this.service.updateReward(id, body) }

  @Delete('rewards/:id')
  @ApiOperation({ summary: 'Supprimer une récompense' })
  async deleteReward(@Param('id') id: string) { return this.service.deleteReward(id) }

  @Get('customers')
  @ApiOperation({ summary: 'Clients avec points' })
  async listCustomerPoints(@Query() query: any) { return this.service.listCustomerPoints(query) }

  @Get('customers/:id')
  @ApiOperation({ summary: 'Points fidélité d\'un client' })
  async getCustomerPoints(@Param('id') id: string) { return this.service.getCustomerPoints(id) }

  @Get('customers/:id/transactions')
  @ApiOperation({ summary: 'Historique des transactions de points' })
  async getTransactions(@Param('id') id: string) { return this.service.getTransactions(id) }

  @Put('customers/:id/points')
  @ApiOperation({ summary: 'Ajuster les points' })
  async adjustPoints(@Param('id') id: string, @Body() body: { balance: number; reason?: string }) {
