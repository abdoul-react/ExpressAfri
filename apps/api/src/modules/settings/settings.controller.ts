...
export class SettingsController {
  ...
  async listSettings() { return this.service.listSettings() }

  @Get('feature-flags')
  @ApiOperation({ summary: 'Liste des fonctionnalités (public pour le mobile)' })
  @Public()
  ...
  async toggleFeatureFlag(@Param('key') key: string, @Body() body: { enabled: boolean }) {
