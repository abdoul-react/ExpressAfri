...
const LOGO_UPDATES: Record<string, string> = {
  ...
  orange_money: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Orange_logo.svg/200px-Orange_logo.svg.png',
  ...
  try {
    ...
    for (const row of result.rows) {
      ...
      if (newUrl) {
        ...
        console.log(`    ⚠ Pas de remplacement défini pour '${row.code}'. Mettez à jour LOGO_UPDATES dans ce script.\n`)
      }
    }
